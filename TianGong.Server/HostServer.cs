...
namespace TianGong.Server
{
    ...
    {
        IEnumerable<ILoggerProvider> _loggerProviders;
        public HostServer(IEnumerable<ILoggerProvider> loggerProviders)
        {
        ...
        public void SetConsoleLogger() => _loggerProviders.ToList().ForEach(o => InternalLoggerFactory.DefaultFactory.AddProvider(o));
    }
}
